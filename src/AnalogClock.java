...
public class AnalogClock extends Clock{
    ...
    public static void toSvg(String fPath) throws IOException {
        FileWriter myWriter = new FileWriter(fPath);
        myWriter.write("<svg width=\"200\" height=\"200\" viewBox=\"-100 -100 200 200\" xmlns=\"http://www.w3.org/2000/svg\">\n" +
                "  <!-- Tarcza zegara -->\n" +
